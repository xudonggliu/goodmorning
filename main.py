...
data = {"city":{"value":city,"color":"#20B2AA"},"weather":{"value":wea,"color":"#87CEFA"},"temperature":{"value":temperature,"color":"#FFB6C1"},"min_temperature":{"value":get_weather_low(),"color":"#008000"},"humidity":{"value":get_humidity()},"kongqizhiliang":{"value":get_zhiliang()},"max_temperature":{"value":get_weather_high(),"color":"#CD5C5C"},"love_days":{"value":get_count(),"color":"#9ACD32"},"birthday_left":{"value":get_birthday(),"color":"#FF0000"},"words":{"value":get_words(), "color":get_random_color()},"onewords":{"value":get_words(), "color":get_random_color()}}
